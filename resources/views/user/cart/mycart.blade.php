    ...
    <div class="container mb-80 mt-20">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row mt-30">
                    <div class="col-lg-4">
                        <div class="calculate-shiping p-40 border-radius-15">
                        ...
                        @else
                            <div class="p-40" id="couponField">
                                ...
                                <div class="d-flex justify-content-between mb-10">
                                    <input class="font-medium mr-15 coupon" placeholder="Enter Your Coupon" id="coupon_name" autocomplete="off">
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="p-md-4 cart-totals ml-30">
