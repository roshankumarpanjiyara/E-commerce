@php
    ...
    $subcategory = SubCategory::select('sub_categories.*', DB::raw('count(products.id) as posts_count'))
        // ->with('product')
        ...
        <div class="container pt-15 pb-20">
            <div class="row">
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="logo mb-30">
                            <a href="/" class="mb-5"><img src="{{asset($website->logo)}}" alt="logo" style="width:250px"/></a>
                            <p class="font-lg text-heading">{{$website->company_slogan}}</p>
                        </div>
                        <ul class="contact-infor">
                            <li><img src="{{asset("frontend/assets/imgs/theme/icons/icon-location.svg")}}" alt="" /><strong>Address: </strong> <span>{{$website->company_address}}</span></li>
                            <li><img src="{{asset("frontend/assets/imgs/theme/icons/icon-contact.svg")}}" alt="" /><strong>Call Us:</strong><span>(+91) - {{$website->phone}}</span></li>
                            <li><img src="{{asset("frontend/assets/imgs/theme/icons/icon-email-2.svg")}}" alt="" /><strong>Email:</strong><span>{{$website->email}}</span></li>
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                    <h4 class="widget-title">{{$website->company_name}}</h4>
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                    ...
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        @forelse ($subcategory as $item)
                            <li><a href="{{Route('product.subcategory.details',[$item->id])}}?category={{$item->category->slug}}&subcategory={{$item->slug}}">{{$item->name}}</a></li>
                        @empty
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                <div class="hotline d-lg-inline-flex">
                    ...
                    <p>{{$website->phone}}<span>24/7 Support Center</span></p>
                </div>
            </div>
                    ...
                    miniCart +=
                        `<li>
                            ...
                            <div class="shopping-cart-title">
                                ...
                                <h4><span>${value.options.size} - ${value.qty} × </span>${value.price}</h4>
                            </div>
