    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" action="{{route("products.store")}}" method="post" enctype="multipart/form-data">@csrf
                    <!--begin::Aside column-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" autocomplete="off" required name="product_name" class="form-control mb-2 @error('product_name') is-invalid @enderror" placeholder="Product name" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                @error('product_name')
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input id="kt_ecommerce_add_product_tags" placeholder="Enter tags for product" name="product_tags" class="form-control mb-2 @error('product_tags') is-invalid @enderror" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                @error('product_tags')
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <textarea name="short_description" class="min-h-100px mb-2 form-control form-control-lg @error('short_description') is-invalid @enderror" placeholder="Product Short Description"></textarea>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                            ...
                                            <div>
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <textarea name="long_description" id="editor_long" class="min-h-100px mb-2 form-control form-control-lg @error('long_description') is-invalid @enderror" placeholder="Product Long Description"></textarea>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="fv-row mb-2">
                                                <!--begin::Input-->
                                                <input type="file" name="multi_image[]" class="form-control mb-2 @error('multi_image') is-invalid @enderror" multiple id="multiImg"/>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Description-->
                                            ...
                                            <div class="symbol symbol-60px symbol-2by3 me-5 mt-5" id="preview_img">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" autocomplete="off" required name="base_price" class="form-control mb-2 @error('base_price') is-invalid @enderror" placeholder="Base price" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" autocomplete="off" required name="selling_price" class="form-control mb-2 @error('selling_price') is-invalid @enderror" placeholder="Selling price" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-0 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" autocomplete="off" name="discount_price" class="form-control mb-2 @error('discount_price') is-invalid @enderror" placeholder="Discount price" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" autocomplete="off" name="product_sku" class="form-control mb-2 @error('product_sku') is-invalid @enderror" placeholder="SKU Number" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                @error('product_sku')
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="number" min="0" autocomplete="off" name="product_qty" required class="form-control mb-2 @error('product_qty') is-invalid @enderror" placeholder="Quantity" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                @error('product_qty')
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input value="" id="kt_tagify_2" placeholder="Enter size for product" name="product_size" class="form-control mb-2 @error('product_size') is-invalid @enderror" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                @error('product_size')
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="fv-row">
                                                ...
                                                <div class="d-flex flex-row gap-10">
                                                    ...
                                                    <!--begin::Input-->
                                                    <div class="form-check form-check-custom form-check-success form-check-solid mb-2 d-flex flex-wrap">
                                                        <input class="form-check-input" name="special_deal" type="checkbox" value="1" />
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" autocomplete="off" class="form-control mb-2 @error('meta_title') is-invalid @enderror" name="meta_title" placeholder="Meta tag name" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                @error('meta_title')
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <textarea name="meta_description" class="min-h-100px mb-2 form-control form-control-lg @error('meta_description') is-invalid @enderror" placeholder="Meta Description"></textarea>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                            ...
                                            <div>
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <input id="kt_ecommerce_add_product_meta_keywords" autocomplete="off" placeholder="Meta Keywords" name="meta_keywords" class="form-control mb-2 @error('meta_keywords') is-invalid @enderror" />
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                                @error('meta_keywords')
                                                    <span class="invalid-feedback" role="alert">
